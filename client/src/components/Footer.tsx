...
export default function Footer() {
  return (
    <footer className="relative bg-[#0D0D0D] text-white pt-16 md:pt-24 pb-8 overflow-hidden">
      {/* Spotlight gradient */}
      <div
      ...
      <div className="container relative">
        {/* Top — logo + links in 12-col grid */}
        <div className="grid grid-cols-12 gap-4 pb-12 md:pb-16 border-b border-[#1A1A1A]">
          {/* Logo + tagline */}
          <div className="col-span-12 md:col-span-5">
            <a
              href="#top"
              className="lumet-logo text-3xl md:text-4xl"
              aria-label="Lumet Studios home"
            >
              Lumet<span className="text-[#1D4ED8]">.</span>
            </a>
            <p className="lumet-body mt-6 text-base text-[#A3A3A3] max-w-sm">
              The studio behind the studios. White-label fulfillment for
              marketing agencies and niche-service businesses.
            </p>
            <p className="font-mono-label text-[#525252] mt-6">
          ...
          <div className="col-span-6 md:col-span-3 md:col-start-7">
            <p className="font-mono-label text-[#525252] mb-5">SERVICES</p>
          ...
          <div className="col-span-6 md:col-span-2">
            <p className="font-mono-label text-[#525252] mb-5">STUDIO</p>
            <ul className="space-y-3">
          ...
          <div className="col-span-12 md:col-span-2">
            <p className="font-mono-label text-[#525252] mb-5">CONTACT</p>
            <a
        ...
        {/* Bottom — copyright + back to top in 12-col grid */}
