    ...
    <div>
      ...
      >
        <div>
          ...
          <p className={`lumet-body mt-1 text-sm md:text-base ${muted}`}>
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className={`lumet-cta w-11 h-11 flex items-center justify-center border ${border} ${heading} hover:border-[#1D4ED8] hover:text-[#1D4ED8] transition-colors`}
          >
            ←
          </button>
          <button
      ...
      <p className={`lumet-body mt-6 text-xs md:text-sm ${faint} max-w-3xl`}>
