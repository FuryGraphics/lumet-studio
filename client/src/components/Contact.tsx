 ...
 * Shows success state inline and toast on submit.
 */
          ...
          <div className="grid grid-cols-12 gap-4 lg:gap-12">
            <div className="col-span-12 md:col-span-2 lg:col-span-4">
              ...
              <button
                ...
                className="lumet-cta mt-8 inline-flex items-center gap-2 px-6 py-3 text-sm font-semibold text-[#1D4ED8] border border-[#1D4ED8] hover:bg-[#1D4ED8] hover:text-white rounded-sm"
              >
            ...
            <form onSubmit={handleSubmit} className="space-y-0">
              ...
              <div className="pt-6 md:pt-8">
                <button
                  ...
                  className="lumet-cta inline-flex items-center gap-2 px-8 py-4 text-base font-semibold text-white bg-[#1D4ED8] hover:bg-[#1741B0] rounded-sm disabled:opacity-50 disabled:cursor-not-allowed"
                >
