      ...
      <div ref={ref} className={`container ${isVisible ? "is-visible" : ""}`}>
        ...
        <div className="grid grid-cols-12 gap-6 lg:gap-12 mb-12 md:mb-20 items-center">
          ...
          <div className="col-span-12 lg:col-span-5">
            ...
            <p className="lumet-body mt-6 text-base md:text-lg text-[#525252] max-w-xl">
            ...
            <div className="mt-8 flex flex-col sm:flex-row items-start sm:items-center gap-4">
              <Link
                ...
                className="lumet-cta inline-flex items-center gap-2 px-6 py-3.5 text-base font-semibold text-white bg-[#1D4ED8] hover:bg-[#1741B0] rounded-sm"
              >
