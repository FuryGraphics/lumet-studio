...
export default function Industries() {
  usePageMeta(
    "Industries We Serve | Lumet Studios",
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-px bg-[#E5E5E5] border border-[#E5E5E5]">
          {industries.map((ind, i) => (
            <div key={ind.name} className="bg-[#FAFAF9] p-6 md:p-10">
              ...
              <p className="lumet-body mt-4 text-sm md:text-base text-[#525252]">
                {ind.body}
              </p>
            </div>
          ))}
        </div>
        <p className="lumet-body mt-8 text-base text-[#525252]">
          Don't see your industry?{" "}
          <a href="/#contact" className="lumet-link font-medium text-[#1D4ED8]">
            Tell us what you do
          </a>
